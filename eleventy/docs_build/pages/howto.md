  ...
  <div class="columns is-mobile is-multiline is-centered">
    ...
    <div class="tab-content pb-4 mb-0">
      ...
      <div class="full-height-scrollable">
        ...
        <button class="button mb-2 tooltip-arrow tooltip-top" style="--tooltip-z-index: 1234;" data-tooltip="Z-Index of 1234">Z-Index of 1234</button>
        <span class="is-size-5 mt-4 mr-4">Width</span>
        <button class="button mb-2 tooltip-arrow tooltip-top" style="--tooltip-width: 70px;" data-tooltip="Width of 70px">Width of 70px</button>
        <br/>
        <span class="is-size-5 mt-4 mr-4">Border Radius</span>
        <button class="button mb-2 tooltip-arrow tooltip-top" style="--tooltip-border-radius: 12px;" data-tooltip="Border Radius of 12px">Border Radius of 12px</button>
        <span class="is-size-5 mt-4 mr-4">Custom Color</span>
        <button class="button mb-2 tooltip-arrow tooltip-top" style="--tooltip-background-color: black;--tooltip-foreground-color: red;" data-tooltip="Background Black, Foreground Red">Background Black, Foreground Red</button>
...
<div style="margin: 8px;">
    ...
    <a class="tooltip-chip tooltip-arrow tooltip-left tooltip-large button" data-tooltip="Custom Chip">Test</a></p>
